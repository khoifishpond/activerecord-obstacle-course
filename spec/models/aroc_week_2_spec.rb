...
# ----------------------
  ...
  it '9. finds orders for a user' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders_of_user_3 = Order.joins(:user).where(user_id: @user_3.id)
    # ------------------------------------------------------------
  ...
  it "13. groups an order's items by name" do
    ...
    # ------------------ Using ActiveRecord ----------------------
    grouped_items = Item.joins(order_items: :order).where(orders: {id: @order_3.id})
    # ------------------------------------------------------------
  ...
  it '15. gets all item names associated with all orders' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    names = Item.joins(order_items: :order).pluck(:name)
    # ------------------------------------------------------------
